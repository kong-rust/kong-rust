...
| Spec 文件 | 初始 | 最终 | 通过率 | 提升 |
|-----------|------|------|--------|------|
| 00-smoke (all) | 59/59 | **59/59** | **100%** ✅ | - |
| 04-admin_api/10-services_routes | 12/75 | **59/75** | **79%** | +47 |
| 04-admin_api/03-consumers_routes | 17/99 | **57/99** | **58%** | +40 |
| 04-admin_api/02-kong_routes | 27/87 | **38/87** | **44%** | +11 |
| 04-admin_api/04-plugins_routes | 18/26 | **19/26** | **73%** | +1 |
| 04-admin_api/14-tags | 5/14 | **10/14** | **71%** | +5 |
| 05-proxy/08-uri_encoding | 0/5 | **5/5** | **100%** ✅ | +5 |
| **总计** | **138/365** | **247/365** | **68%** | **+109** |

        ...
        "ai-proxy" => Some(json!({
            "fields": [
                ...
                {"config": {"type": "record", "required": true, "fields": [
                    {"model": {"type": "record", "fields": [
                        {"provider": {"type": "string", "required": true, "one_of": [
                    ...
                    {"model_group": {
                        "type": "string",
                        "description": "kong-rust extension: resolve this model group from AI Provider and AI Model entities."
                    }},
